          ...
          <div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl p-8 border border-purple-500/20">
            <div className="prose prose-invert max-w-none">
              <p className="text-sm text-gray-500 mb-8">
                Настоящий документ является официальным предложением (офертой) �?П/самозанятого. 
              ...
              <p className="text-gray-300 mb-6">
                1.1. «Продавец» — �?горь Глебов Александрович (�?П/самозанятый) с �?НН 20639063753, предоставляющий доступ к программному обеспечению Aura Client.
              </p>
              <p className="text-gray-300 mb-6">
                1.2. «Покупатель» — физическое лицо, осуществившее оплату и регистрацию на Сайте.
              </p>
              <p className="text-gray-300 mb-6">
                1.3. «Товар» — программное обеспечение Aura Client для Minecraft 1.21.4, предоставляемое на условиях простой неисключительной лицензии.
              </p>
              <p className="text-gray-300 mb-6">
              ...
              <p className="text-gray-300 mb-6">
                6.2. �?спользование на свой страх и риск. Продавец не гарантирует отсутствия багов в программном обеспечении.
              </p>
              <p className="text-gray-300 mb-6">
              ...
              <div className="bg-gray-900/50 rounded-lg p-4 font-mono text-sm">
                <p className="text-gray-300 mb-2">
                  <strong>Продавец:</strong> �?горь Глебов Александрович (�?П/самозанятый)
                </p>
                <p className="text-gray-300 mb-2">
                  <strong>�?НН:</strong> 20639063753
                </p>
                <p className="text-gray-300 mb-2">
