...
const PAYMENT_TIERS = {
  beta: { amount: 99, currency: 'RUB', description: 'Aura Client - Beta access' },
  '1_month': { amount: 299, currency: 'RUB', description: 'Aura Client - Premium 1 month' },
  lifetime: { amount: 1999, currency: 'RUB', description: 'Aura Client - Lifetime' },
  hwid_reset: { amount: 49, currency: 'RUB', description: 'Aura Client - HWID reset' }
};
...
function getEnvConfig() {
  ...
  if (!shopId || !secretKey) {
    return { ok: false, error: 'Missing YOOKASSA_SHOP_ID or YOOKASSA_SECRET_KEY' };
  }
